...
1.5.9-SNAPSHOT (**current stable**)| 2016-02-04   | 2.0           | [tag v1.5.9-SNAPSHOT](https://github.com/swagger-api/swagger-core/tree/v1.5.9-SNAPSHOT) | Supported
...
### To build from source (currently 1.5.6)
```
